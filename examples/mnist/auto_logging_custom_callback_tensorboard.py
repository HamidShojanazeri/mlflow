...
class MLFlowTracking_log_artifacts(Callback):
    ...
    def log_weights(self,step):
        writer.add_histogram('weights/conv1/weight', self.learn.model.conv1.weight.data, step)
        writer.add_histogram('weights/conv1/bias', self.learn.model.conv1.bias.data, step)
        writer.add_histogram('weights/conv2/weight', self.learn.model.conv2.weight.data, step)
        writer.add_histogram('weights/conv2/bias', self.learn.model.conv2.bias.data, step)
        writer.add_histogram('weights/fc1/weight', self.learn.model.fc1.weight.data, step)
        writer.add_histogram('weights/fc1/bias', self.learn.model.fc1.bias.data, step)
        writer.add_histogram('weights/fc2/weight', self.learn.model.fc2.weight.data, step)
        writer.add_histogram('weights/fc2/bias', self.learn.model.fc2.bias.data, step)
    ...
    def after_batch(self):
        self.log_weights(self.run.n_iter)
        if self.in_train:
            writer.add_scalar('loss', self.loss.data.item(), self.run.n_iter)
